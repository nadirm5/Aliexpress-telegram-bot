...
OFFER_PARAMS = {
     "coin": {
        "name": "🪙 Coins اضغط هنا أقل سعر رابط العملات👉",
        "params": {
            "sourceType": "620%26channel=coin",
            "afSmartRedirect": "y"
        },
        "price": "20 USD"  # Remplacer par le prix réel
    },
    "coin": {"name": "🪙 Coins اضغط هنا أقل سعر رابط العملات👉", "params": {"sourceType": "620%26channel=coin", "afSmartRedirect": "y"}},
